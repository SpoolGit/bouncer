...
def show_page8():
    ...
    st.markdown("""
        <p style="font-size: 1.5rem; font-weight: 400; color: #3A5EFF;">
            Please upload your GL relevant files here
        </p>
    """, unsafe_allow_html=True)
    ...
    def go_next():
        ...
        st.session_state.selection = "TB-Regen O/P"
        st.session_state.page_reroute = True

    with col1:
        st.button("⬅️ Back", key="page8_back", on_click=go_back)

    with col2:
        st.button("Next ➡️", key="page8_next", on_click=go_next)
